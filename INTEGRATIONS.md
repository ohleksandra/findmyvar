...
2. Add Tailwind classes to your HTML
3. Example: `<div class="flex items-center justify-center">`
4. Add components using `npx shadcn@latest add button`
5. Import components from `@/components/ui`
6. Visit https://ui.shadcn.com/docs/components for available components
...
3. Visit https://playwright.dev/ for more information
